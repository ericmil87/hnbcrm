...
export const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  {
    ...
    label: "Imobiliária",
    icon: "Building2",
    boardName: "Pipeline Imobiliário",
    boardColor: "#3B82F6",
    stages: [
      ...
      { name: "Desistência", color: "#6B7280", isClosedLost: true },
    ],
  },
  {
    key: "ecommerce",
    ...
    stages: [
      ...
      { name: "Demonstração", color: "#F59E0B" },
  ...
  },
  {
    ...
    label: "Saúde",
    icon: "HeartPulse",
    boardName: "Pipeline de Saúde",
    boardColor: "#EF4444",
    stages: [
      { name: "Primeiro Contato", color: "#3B82F6" },
      { name: "Avaliação", color: "#8B5CF6" },
      { name: "Orçamento", color: "#F59E0B" },
      { name: "Tratamento", color: "#EC4899" },
      { name: "Concluído", color: "#10B981", isClosedWon: true },
