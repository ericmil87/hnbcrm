...
export const ALL_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    description: "Conta e amostra os leads que um segmento alcançaria (sem criar nada).",
    params: [
    ...
    responseExample: { preview: { count: 42, sample: [{ phone: "5511999990000", displayName: "Maria" }], excluded: { no_phone: 3, opted_out: 1 } } },
  },
  {
    id: "create-campaign",
    method: "POST",
    ...
    params: [
      ...
      { name: "audience", type: "object", required: false, location: "body", description: "{ source: segment|manual|import, filters?, targetBoardId?, targetStageId? }", default: "{ source: manual }" },
