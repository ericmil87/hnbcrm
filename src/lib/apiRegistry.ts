...
export const ALL_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    params: [
      ...
      { name: "content", type: "string", required: false, location: "body", description: "Conteudo da mensagem (obrigatorio sem attachments)" },
  ...
  },
  {
    ...
    description: "Injeta uma mensagem inbound de um contato — para bridges externas de qualquer canal. Cria contato e lead se nao existirem; idempotente por externalId.",
    params: [
      { name: "content", type: "string", required: true, location: "body", description: "Conteudo da mensagem" },
      { name: "contactPhone", type: "string", required: false, location: "body", description: "Telefone do contato (obrigatorio sem contactId; cria o contato se nao existir)" },
      ...
      { name: "leadTitle", type: "string", required: false, location: "body", description: "Titulo do lead criado quando o contato nao tem lead" },
